...
LED_GRAPH_PINS : list[int] = [20, 16, 12, 23, 18, 24, 25, 5, 6, 13]
LEDS = LEDBarGraph(*LED_GRAPH_PINS, active_high=False)
...
def loop():
    while True:
        ...
        if tempF >= 100:
            LEDS.value = 1 # The number 1 lights up all lights in the LED
        elif tempF > 0: # Temp in range (0-100]
            LEDS.value = tempF / 100
        else:
            LEDS.value = 0 # 0 turns off all lights in the LED
